  ...
  return (
    <div className="min-h-screen bg-dark flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-2xl flex flex-col gap-5">
          <div>
          ...
          <button
            ...
            disabled={loading}
            className="flex items-center justify-center gap-3 w-full border border-gray-200 rounded-xl py-3 px-4 font-semibold text-dark hover:bg-gray-50 transition-colors disabled:opacity-60"
          >
            {loading ? (
